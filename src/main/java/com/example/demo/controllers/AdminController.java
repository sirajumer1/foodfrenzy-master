...
public class AdminController {
	...
	public String userLogin(@ModelAttribute("userLogin") UserLogin login, Model model,
		...
		if (services.validateLoginCredentials(email, password)) {
			...
			session.setAttribute("user", user); // Store logic in session

			// Legacy support: Keep 'user' field updated just in case other methods use it,
			// though they should also be updated to use session. Use with caution.
